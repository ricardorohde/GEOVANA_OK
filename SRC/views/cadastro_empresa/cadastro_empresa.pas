...
uses
  ...
  ShellApi,
  ClipBRD, cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters, dxSkinsCore, dxSkinBlack, dxSkinBlue, dxSkinBlueprint,
  dxSkinCaramel,
...
uses   config_certificado,
   config_email, config_nfe, config_mde, config_nfs, config_nfce_;
